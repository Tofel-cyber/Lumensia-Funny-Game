...
scene.background = new THREE.Color(0xFFE0E6);
...
const obstacleMaterials = [
    new THREE.MeshStandardMaterial({ color: 0xFFD700, roughness: 0.1, metalness: 0.1 }),
    new THREE.MeshStandardMaterial({ color: 0xDA70D6, roughness: 0.2, metalness: 0.1 }),
    new THREE.MeshStandardMaterial({ color: 0x00BFFF, roughness: 0.1, metalness: 0.1 }),
];
